...
print(c + "\n\nNote: " + lr + "Use this tool for educational and research purposes only.\n\t")
sleep(1)
...
def builder():
    ...
    if choice == "1":
        ...
        date = input(ran + "Enter date of explosion [Eg: 30/12/2024] :")
        time_bomb_read = f"""
        ...
        sprint(g + "To buy premium malware and viruses, contact Instagram @sajadtlpr. ")
